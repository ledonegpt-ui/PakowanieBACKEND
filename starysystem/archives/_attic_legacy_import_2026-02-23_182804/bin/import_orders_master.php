...
require_once __DIR__ . '/../app/Services/SubiektReader.php';
require_once __DIR__ . '/../app/Services/FirebirdEUReader.php';
require_once __DIR__ . '/../app/Services/BaselinkerBatchReader.php';
require_once __DIR__ . '/../app/Services/OrderRepository.php';
require_once __DIR__ . '/../app/Services/ImporterMaster.php';

function log_line(string $msg): void {
    $path = __DIR__ . '/../storage/logs/import_orders_master.log';
...
try {
    ...
    $repo  = new OrderRepository($mysql);

    $subReader = new SubiektReader($mssql, $cfg, $logger);
    ...
    $imp = new ImporterMaster($mysql, $state, $repo, $subReader, $euReader, $blReader, $cfg, $logger);
    $res = $imp->run();
