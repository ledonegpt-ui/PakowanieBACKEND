...
final class SubiektReader
{
    ...
    private function getSchema(): array
    {
        ...
        ($this->log)("SUBR: schema docTable={$this->schema['docTable']} posTable={$this->schema['posTable']} towTable={$this->schema['towTable']} posDocCol={$this->schema['posDocCol']} twOpisCol=" . ($this->schema['twOpisCol'] ?? 'NULL'));
        return $this->schema;
    }
