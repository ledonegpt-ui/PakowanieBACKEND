...
require_once __DIR__ . '/../../app/Modules/Screens/Controllers/ScreensController.php';
...
['GET', '/api/v1/screens/{stationCode}/current', function (array $params) use ($cfg): void {
    ...
    ['GET', '/api/v1/screens/{stationCode}/stream', function (array $params) use ($cfg): void {

        (new ScreensController($cfg))->stream($params);
    ...
    ['GET', '/api/v1/panel/orders', function (array $params) use ($cfg): void {

        (new PanelOrdersController($cfg))->index();

    }],

    ['GET', '/api/v1/panel/orders/{orderCode}', function (array $params) use ($cfg): void {

        (new PanelOrdersController($cfg))->show($params);

    }],

    ['POST', '/api/v1/panel/orders/{orderCode}/update', function (array $params) use ($cfg): void {
