...
echo "\n==================== RESULT ====================\n";
echo "ORDER STILL PRESENT: " . ($foundOrder ? 'YES' : 'NO') . "\n";

if ($foundOrder) {
    echo "ORDER STATUS: " . (isset($foundOrder['status']) ? $foundOrder['status'] : '') . "\n";
}

if ($foundItem) {
    echo "ITEM STATUS: " . (isset($foundItem['status']) ? $foundItem['status'] : '') . "\n";
    echo "ITEM MISSING_REASON: " . (isset($foundItem['missing_reason']) ? $foundItem['missing_reason'] : '') . "\n";
}
